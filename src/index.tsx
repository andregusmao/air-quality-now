    ...
    <Root>
      ...
      <Container>
        ...
        {status === "ok" && (
          <span>
            <Result>
              Estação de medição: <Location>{location}</Location>
            </Result>
            <Result>
              Qualidade do ar: <Location>{quality}</Location>
              <Quality style={{ backgroundColor: qualityColor }}>
                {qualityType}
              </Quality>
            </Result>
            <Result>
        ...
        {status === "error" && <Error>Cidade não localizada</Error>}
